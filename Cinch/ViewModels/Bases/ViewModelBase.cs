...
namespace Cinch
{
    ...
    /// </list>
    /// </summary>
    public abstract partial class ViewModelBase : PropertyChangedNotifierBase, IDisposable, IParentablePropertyExposer
    {
        #region Data
        ...
        {
            return NewPropertyChanged == null ? null : NewPropertyChanged.GetInvocationList();
        }
